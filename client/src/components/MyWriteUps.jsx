        ...
        fetch(`${SERVER_URL}/writeups/me`, {
            ...
            .then(res => {
                if (res.status === 200) {
                    ...
                    toast.error("Unauthorized. Make sure you are logged in and email verified");
    ...
    return (
        <>
            <div className="min-h-screen bg-black text-green-400 font-mono px-6 sm:px-12 py-10">
                <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-10 text-green-400 drop-shadow-[0_0_3px_#00ff00]">[ MY WRITEUPS ]</h1>

                <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
                    {writeUps.map((w, idx) => (
                        <div
                            key={idx}
                            onClick={() => navigate(`/writeups/${w.writeUpUuid}`)}
